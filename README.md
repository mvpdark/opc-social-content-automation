...
- Trend collection jobs store safety profiles for public-first Playwright-assisted collection, including platform search targets, image-text-only defaults, randomized delays, human-like scrolling, session persistence, and cookie persistence.
