...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "申请路线清单怎么看",
            "先按学校预算、认证和毕业难度做榜单筛选。",
            "申请路线清单要按国内博士、海外博士、在职路径、预算、认证和时间成本做路线取舍。",
            "路线/选择",
        ),
        (
            "没有论文还能读博吗",
        ...
        (
            "没有论文申博清单怎么看",
            "先做项目预算榜，再看认证和学校池。",
            "没有论文申博清单要按项目经历、工作成果、研究计划、背景短板和补强路径判断可行性。",
            "背景补强",
        ),
        (
            "导师匹配前要做的方向自查",
        ...
        (
            "导师清单怎么筛",
            "先按学校预算、认证和毕业难度做榜单筛选。",
            "导师清单要按研究方向、近年论文、课题交集和套磁证据做匹配判断。",
            "导师匹配",
        ),
        (
            "导师匹配清单怎么看",
            "先按学校预算、认证和毕业难度做榜单筛选。",
            "导师匹配清单要按研究方向、论文主题、课题交集和邮件准备度逐项判断。",
            "导师匹配",
        ),
        (
            "在职博士申请时间线怎么排",
        ...
        (
            "转化话术清单怎么看",
            "先按学校预算、认证和毕业难度做榜单筛选。",
            "转化话术清单要按用户需求、预算、项目适配、异议处理和跟进节奏组织。",
            "咨询转化",
        ),
        (
            "博士含金量排行",
        ...
        (
            ...
            "官方来源清单要按官网 URL、项目页、费用页、认证政策和待复核字段做核验清单。",
            "来源核验",
        ),
        (
            "官方来源清单怎么看",
            "先按认证、预算、毕业难度和在职适配做清单维度。",
            "官方来源清单要按官网 URL、项目页、费用页、认证政策和待复核字段做核验清单。",
            "来源核验",
        ),
        (
