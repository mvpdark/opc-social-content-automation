...
3. Why the common behavior fails.
4. Three to five concrete steps.
5. Reassuring close with human-review-safe caveat.

Example opening patterns:

- `姐妹们，硕升博真的不是先套磁！！[哭惹R]`
- `这个顺序很多人一开始就做反了……`
- `先别急着群发邮件～你得先让导师看懂你能研究什么。`
- `宝子，如果方向还没拆清楚，套磁邮件写得再礼貌也容易像模板（真的）`
