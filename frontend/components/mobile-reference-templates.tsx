...
export function MobileReferenceTemplateList({
  onPreview,
  selectedTitle
}: {
        ...
        {sampleReferences.map((item, index) => (
          <button
            ...
            className={[
              ...
              selectedTitle === item.title ? "border-moss ring-2 ring-moss/[0.15]" : "border-[#d6e8df]"
            ].join(" ")}
...
export function ReferencePreviewSheet({
  onClose,
  reference
}: {
  onClose: () => void;
