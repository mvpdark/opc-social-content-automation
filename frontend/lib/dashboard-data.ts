...
export const draftPreview = {
  ...
  status: "待人工确认",
  body:
    "不是先套磁，先把问题想清楚。\n\n硕升博申请第一步，很多人一上来就急着问：要不要现在群发邮件？如果研究方向、读博动机和导师匹配还没想清楚，先发邮件反而容易浪费第一印象。\n\n先把 3 件事写下来：\n1. 你想研究的问题到底是什么，不要只写一个很大的方向。\n2. 这个问题为什么值得继续读博，和你过去的经历有什么关系。\n3. 你要找的导师，是不是刚好在做相近项目，而不是只看学校排名。\n\n套磁邮件不是越早越好，而是越清楚越好。你发出去的第一封邮件，其实是在告诉导师：你是否已经具备初步的研究判断。\n\n所以别急着群发，先把研究方向、动机和匹配理由整理成一页纸。等这页纸能说清楚，再去写邮件，成功率和回复质量都会更稳一点。",
